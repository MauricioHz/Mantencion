...
class Pdf extends FPDF {
	...
	public function reporte1($entidad, $repuestos){
		...
		$this->Ln();
		$this->Cell(30, 5, 'EQUIPO: ', 'TL', '', 'L');
		$this->Cell(160, 5, utf8_decode($entidad->equipo_actividad), 'RTL', '', 'L');
		$this->Ln();
		$this->Cell(30, 5, 'SECTOR: ', 'TL', '', 'L');
		$this->Cell(160, 5, utf8_decode($entidad->sector), 'RTL', '', 'L');
		$this->Ln();
		$this->Cell(30, 5, 'ELEMENTO: ', 'TL', '', 'L');
		$this->Cell(160, 5, utf8_decode($entidad->elemento), 'RTL', '', 'L');
		$this->Ln();
		$this->Cell(30, 5, 'PABELLON: ', 'TL', '', 'L');
		$this->Cell(160, 5, utf8_decode($entidad->pabellon), 'RTL', '', 'L');
		$this->Ln();
		$this->Cell(30, 5, 'ATRIL: ', 'TLB', '', 'L');
		$this->Cell(160, 5, utf8_decode($entidad->atril), 'RTLB', '', 'L');
		$this->Ln();
		$this->Cell(190, 3, '', '', '', '');
		$this->Ln();
