			...
			<div class="panel-body">
				<form class="form-horizontal" id="crear-equipo-actividad"
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select id="id-tipo" name="id-tipo" class="form-control">
								<option value="E" <?php echo ($tipo == 'E')?'seleted':''; ?>>Equipo</option>
								<option value="A" <?php echo ($tipo == 'A')?'seleted':''; ?>>Actividad</option>
							</select> <span class="help-block">Seleccione si la infomación a
								ingresar corresponde a un <i>Equipo</i> o una <i>Actividad</i> </span>
						</div>
					</div>
					<div class="form-group">
