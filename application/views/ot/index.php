            ...
            <div id="navbar" class="navbar-collapse collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li>
                           <a href="<?php echo base_url('index.php/mantenimiento/programasemana'); ?>"><img src="/assets/image/user.svg" width="25" height="25">  Programa semanal</a>
                        </li>
                        <li><a
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo base_url('index.php/bodega/index'); ?>">Listar bodegas</a></li>                       
                     </ul>
                  </li>
                  <li><a
               ...
               <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                     <a href="#" class="dropdown-toggle"
                        data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fa fa-circle" style="color: #05B905;"></i> 
