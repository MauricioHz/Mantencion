                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url('index.php/mantenimiento/programasemana'); ?>"><i class="fa fa-thumb-tack" style="color: green;"></i> Programa semanal (test)</a>
                                </li>                                
                                <li><a
                                ...
                                <li><a
                                        href="<?php echo base_url('index.php/mantenimiento/registro'); ?>"><i class="fa fa-file" style="color: green;"></i> Registro
                                        de apoyo mantenciones RA-G-2.8</a></li>
                                <li role="separator" class="divider"></li>
                                ...
                                <li><a
                                        ...
                                        Programa de Mantención Preventivo</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle"
                                                data-toggle="dropdown" role="button" aria-haspopup="true"
