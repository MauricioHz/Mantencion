...
<div class="row">
	<form class="form-horizontal"
		action="<?php echo base_url('index.php/mantenimiento/preventivo'); ?>"
		method="POST">
		<div class="col-lg-10 col-lg-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading text-center">Mantención PREVENTIVA</div>
				<div class="panel-body">
					<ul class="nav nav-tabs" id="myTabs" role="tablist">
						<!-- menu class="active"-->
						<li role="presentation" class="active"><a href="#paso1"
							id="home-tab" role="tab" data-toggle="tab" aria-controls="paso1"
							aria-expanded="true"><span class="badge">1</span> Datos mantención Preventiva</a></li>
