...
<div class="panel panel-default">
				...
				<div class="panel-heading" role="tab" id="collapseListGroupHeading1">
					<h4 class="panel-title">
						<a href="#collapseListGroup1" class="" role="button"
							...
							aria-controls="collapseListGroup1"> Datos equipo </a>
					</h4>
				</div>
	...
	<form class="form-horizontal" id="form-crear-programa"
		action="<?php echo base_url('index.php/mantenimiento/crear'); ?>"
		method="post">
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">Subárea</label>
				<div class="col-sm-10">
					<p class="form-control-static">
					<?php echo $subarea; ?>
					</p>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">ObservaciÃ³n</label>
				<div class="col-sm-10">
					<p class="form-control-static">
