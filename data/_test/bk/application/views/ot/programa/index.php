...
<div class="panel panel-default">
	...
	<form class="form-horizontal" id="form-crear-programa" action="<?php echo base_url('index.php/mantenimiento/crear'); ?>" method="post">
		...
		<p>A continuación ingrese el nombre de la actividad a realizar y seleccione las semanas que se requiere la mantención del equipo, se puede ingresar hasta 100 caracteres.</p> </div>			
