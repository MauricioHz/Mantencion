...
<?php if ($mensaje == 'INSERTA_OK') { ?>
<div class="alert alert-success alert-dismissible" role="alert">
   <button type="button" class="close" data-dismiss="alert"
      aria-label="Close">
   <span aria-hidden="true">×</span>
   </button>
   <strong>Mensaje:</strong> Equipo o actividad ingresado correctamente.
</div>
<?php } ?>
<?php if ($mensaje == 'EXISTE_OK') { ?>
<div class="alert alert-warning alert-dismissible" role="alert">
   <button type="button" class="close" data-dismiss="alert"
      aria-label="Close">
   <span aria-hidden="true">×</span>
   </button>
   <strong>Mensaje:</strong> El equipo ya existe en la base de datos.
</div>
<?php } ?>
            ...
            <form class="form-horizontal" id="crear-equipo-actividad"
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-8">
                     ...
                     <span class="help-block">200 caracteres.</span>
                  </div>
               </div>
               <div class="form-group">
